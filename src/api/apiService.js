...
export const API_ENDPOINTS = {
  ...
  videos: {
    ...
    toggleActive:   (id) => axiosInstance.post(`${baseURL}/videos/videos/${id}/toggle_active/`),
    toggleFeatured: (id) => axiosInstance.post(`${baseURL}/videos/videos/${id}/toggle_featured/`),
  },
